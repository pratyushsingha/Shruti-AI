                ...
                <ul className="space-y-2">
                  {conversation.map((item, id) => (
                    ...
                    >
                      ...
                      <div
                        className={`relative max-w-xl px-4 py-2 mx-2 ${
                          item.role === "user"
                            ? "text-white text-bold bg-gray-500 rounded-lg rounded-tl-none"
                            : "text-white bg-[#766AC8] text-bold rounded-lg rounded-tr-none"
                        } rounded shadow`}
                      >
                ...
                <div className="flex items-center bg-white ml-2 mr-2 rounded-xl">
                  <div className="flex w-full space-x-1">
                    ...
                    <button onClick={handleToggleClick}>
                      {!isListening ? (
                        <span className="material-symbols-outlined self-center pr-3 bg-slate-400 rounded-full px-2 py-2">
                          mic
                        </span>
                      ) : (
                        <Equilizer />
